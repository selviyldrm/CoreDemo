   ...
   public class BlogValidator :AbstractValidator<Blog>
    {
        public BlogValidator()
        {
            ...
            RuleFor(x => x.BlogContent).MinimumLength(5).WithMessage("Lütfen en az 5 karakter girişi yapınız.");
            RuleFor(x => x.BlogContent).MaximumLength(10000).WithMessage("Lütfen en fazla 10000 veri girişi yapınız.");
